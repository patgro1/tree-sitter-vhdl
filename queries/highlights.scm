...
(signal_declaration (identifier_list (identifier) @variable.builtin))
(subtype_indication (type_mark (simple_name) @type))
(full_type_declaration name: (identifier) @type)
(index_subtype_definition (type_mark (simple_name) @type))
(resolution_function (simple_name) @function.builtin)
[
    "access"
    "after"
    "alias"
